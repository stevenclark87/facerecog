...
const Signin = ({ onRouteChange }) => {
  ...
  <div className="measure">
    ...
    <div className="">
      <input className="b ph3 pv2 input-reset ba b--white bg-white grow pointer f6 dib" onClick={() => onRouteChange('home')} type="submit" value="Sign in" />
    </div>
    <div className="lh-copy mt3">
      <p className="f6 link dim white db" onClick={() => onRouteChange('register')}>Register</p>
    </div>
  </div>
</main>
</article>
